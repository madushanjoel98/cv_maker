...
function generateDoubleColumnTemplate(data) {
    ...
    // Name and Title
    html += `<div><h1>${data.fullName}</h1>`;
    if (data.professionalTitle) html += `<p style="color: #7f8c8d; font-size: 18px; margin-bottom: 20px;">${data.professionalTitle}</p></div>`;
